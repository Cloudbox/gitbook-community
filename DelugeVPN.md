# DelugeVPN
[DelugeVPN](https://github.com/binhex/arch-delugevpn) is a Torrent Client with OpenVPN to ensure a secure and private connection to the Internet, including use of iptables to prevent IP leakage when the tunnel is down.

See [Deluge Wiki](https://github.com/Cloudbox/Community/wiki/Deluge) for how to use.
Default password for the webui is "deluge", please change this before doing anything else.
